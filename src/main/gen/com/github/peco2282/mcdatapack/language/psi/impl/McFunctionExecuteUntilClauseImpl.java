...
public class McFunctionExecuteUntilClauseImpl extends ASTWrapperPsiElement implements McFunctionExecuteUntilClause {

  public McFunctionExecuteUntilClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitExecuteUntilClause(this);
  }
