...
public class McFunctionJsonObjectImpl extends ASTWrapperPsiElement implements McFunctionJsonObject {

  public McFunctionJsonObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
