...
public class McFunctionExecuteWhileClauseImpl extends ASTWrapperPsiElement implements McFunctionExecuteWhileClause {

  public McFunctionExecuteWhileClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitExecuteWhileClause(this);
  }
