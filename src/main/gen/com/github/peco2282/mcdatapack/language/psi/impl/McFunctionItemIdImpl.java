...
public class McFunctionItemIdImpl extends ASTWrapperPsiElement implements McFunctionItemId {

  public McFunctionItemIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull McFunctionVisitor visitor) {
    visitor.visitItemId(this);
  }
